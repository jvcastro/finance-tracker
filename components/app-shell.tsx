...
const nav = [
  { href: "/", label: "Dashboard", shortLabel: "Home", icon: IconLayoutDashboard },
  { href: "/income", label: "Income", shortLabel: "Income", icon: IconTrendingUp },
  { href: "/expenses", label: "Expenses", shortLabel: "Spend", icon: IconTrendingDown },
...
function MobileBottomNav() {
  ...
  return (
    <nav
      className="bg-background/95 supports-backdrop-filter:backdrop-blur-md border-border fixed right-0 bottom-0 left-0 z-50 border-t md:hidden"
